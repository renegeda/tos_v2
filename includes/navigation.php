                      ...
                      <li class="dropdown ms-2 d-inline-block position-static">
                        <a class="rounded-circle" href="#" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">
                            <div class="avatar avatar-md avatar-indicators avatar-online">
                                <img src="<?= htmlspecialchars($_SESSION['avatar_web']) ?>" 
                                 class="rounded-circle"
                                 onerror="this.onerror=null; this.src='/tso/assets/img/stuff/avatar-default.jpg'">
                            </div>
                        </a>
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="ms-3 lh-1">
                                        <?php if (isset($_SESSION['user_login'])): ?>
                                            <h5 class="mb-1"><?= htmlspecialchars($_SESSION['user_login']) ?></h5>
                                            <p class="mb-0 text-role-<?= htmlspecialchars($_SESSION['user_role']) ?>">
                                                <?= htmlspecialchars(ucfirst($_SESSION['user_role'])) ?>
                                            </p>
                                        <?php else: ?>
                                            <h5 class="mb-1">Гость</h5>
                                            <p class="mb-0 text-muted">Не авторизован</p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
